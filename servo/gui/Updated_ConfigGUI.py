...
class MainApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        logo = tk.PhotoImage(file=Root_Dir + '/Images/megaralogo.png')
            
##############  Top Frame #####################################################
        self.top_frame = tk.Frame(self, height=int(self.app_height / 15), bd=2,
                                  width=self.app_width, bg="magenta")
        self.top_frame.pack(padx=(225, 0), side="top", fill="both")
        self.top_frame.pack_propagate(0)

############# Left Frame ######################################################
        self.left_frame = tk.Frame(self, width= int(self.app_width / 4 ), bg="pink")
        self.left_frame.pack(side="left", fill="both")
        self.left_frame.pack_propagate(0)

        self.right_frame = tk.Frame(self, bg="pink")
        self.right_frame.pack(side="left", fill="both", expand=True)

        self.label_font = font.Font(family="TkDefaultFont", size=10)
        self.heading_font = font.Font(family="TkDefaultFont", size=12)
        ...
        tk.Label(self, text="Servo Motor", bg="cyan",
                 fg='SteelBlue',
    ...
    def close_robot(self):
        ...
        try:
            ...
            pass
        logging.info('Servo Closed Successfully..!!')
        self.destroy()
...
class AboutFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, bg="white", fg="SteelBlue2", text="Megara Robotics",font=('Helvetica', 25))
        label.grid(row=0, column=0, padx=200, pady=30)

        #text = tk.Label(self, bg="white", fg="black", font=('Helvetica', 11),text="SB components Serial Servos")
        #text.grid(row=1, column=0, padx=(0, 150))

        text = tk.Label(self, bg="white", fg="black", font=('Helvetica', 11),
                        text="One of the leading companies in innovative robots for humanitarian cause")
        text.grid(row=2, column=0, padx=(0, 425))

        # text = tk.Label(self, bg="white", fg="black", font=('Helvetica', 11),text="2. Serial UART Control")
        ...
        website = tk.Button(self, bg="SteelBlue2", fg="white",
                            font=('Helvetica', 15),
                            text="http://www.megararobotics.com/",
    ...
    @staticmethod
    def mainWebsite():
        webbrowser.open("http://www.megararobotics.com/")
